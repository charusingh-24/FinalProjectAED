...
public class PharmacyManWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        workRequestJTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Order-ID", "Message", "Status", "Patient Name", "Patient Address", "Hospital", "Hospital Address"
            }
        ) {
        ...
        add(processJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 400, 80, 20));
        ...
        add(refreshJButton, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 400, 70, 20));
        ...
        tbldeliveryMan.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Order-ID", "Patient Name", "Patient Address", "Hospital", "Hospital Address", "Status"
            }
        ));
        ...
        titleDeliveryMan.setText("PHARMACY");
        ...
        add(sendEmail, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 430, -1, -1));
        ...
        add(emailText, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 430, 330, 150));
    ...
    public void populateDeliveryManTable(){
        ...
        if(order.getDeliveryMan()!=null && order.getDeliveryMan().equals(userAccount.getEmployee().getName())){
            ...
            row[5]=order.getCustomer().getEmail();
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        if(order.getOrderStatus().equals("Patient Vaccinated")){
        JOptionPane.showMessageDialog(null, "Patient already vaccinated.");
        return;
        }
        
        order.setOrderStatus("Patient Vaccinated");
    ...
    private void assignJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_assignJButtonActionPerformed
        ...
        order.setOrderStatus("Vaccination Confirmed.");
        populateTable();
        populateDeliveryManTable();
    ...
    private void sendEmailActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendEmailActionPerformed
        ...
        SendMail((String) tbldeliveryMan.getValueAt(selectedRow, 5),text);        // TODO add your handling code here:
        }
