...
public class PharmacyManWorkAreaJPanel extends javax.swing.JPanel {
    ...
    private void processJButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_processJButtonActionPerformed
        ...
        if(order.getOrderStatus().equals(OrderStatus.PATIENT_VACCINATED.getValue())){
        JOptionPane.showMessageDialog(null, "Patient is already vaccinated.");
        return;
        }
        
        order.setOrderStatus(OrderStatus.PATIENT_VACCINATED.getValue());
        
        JOptionPane.showMessageDialog(null, "Patient has been vaccinated.");
        populateDeliveryManTable();
