...
public class DeliveryManDirectory {
    ...
    public DeliveryMan newDeliveryMan(String name, String address, String email, String phoneNumber, int age, String pass) {
        DeliveryMan deliveryMan = new DeliveryMan(name, address, email, phoneNumber, age, pass);
